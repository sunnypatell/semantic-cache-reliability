...
reproducible label for a private one. We do not claim the residual bias favors our thesis; it
could run either way, since a labeled non-paraphrase may occasionally admit the same answer
(inflating the measured rate) while a labeled paraphrase may need a different one in context
(deflating it). The claim is narrower: the labels track a public, reproducible notion of
