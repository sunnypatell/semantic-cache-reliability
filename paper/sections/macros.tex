...
\newcommand{\cfh}{c_{\mathrm{fh}}} % false-hit cost penalty (calls per false hit)
\newcommand{\cov}{\mathrm{cov}}    % coverage (fraction served)
\newcommand{\cost}{C}              % expected cost per query
