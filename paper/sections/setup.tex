...
control, which isolates how much of the cache's behavior comes from learned semantics
...
metric, and the sample sizes were preregistered before the main run.
